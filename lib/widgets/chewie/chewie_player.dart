...
import 'package:v_player/widgets/chewie/player_with_controls.dart';
...
class ChewieState extends State<Chewie> {
  ...
  void listener() async {
    if (!_isInitialized && widget.controller.videoPlayerController.value.initialized) {
      setState(() {
        _isInitialized = true;
      });
    }
  ...
  Widget build(BuildContext context) {
    return _ChewieControllerProvider(
      ...
      child: PlayerWithControls(aspectRatio: widget.controller.aspectRatio ?? _calculateAspectRatio(widget.controller, context),),
    );
  }
  ...
  double _calculateAspectRatio(ChewieController chewieController, BuildContext context) {
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    var controllerProvider = _ChewieControllerProvider(
      controller: widget.controller,
      child: PlayerWithControls(aspectRatio: _calculateAspectRatio(widget.controller, context),),
    );
  ...
  Future<dynamic> _pushFullScreenWidget(BuildContext context) async {
    ...
    bool isRotate = widget.controller.videoPlayerController.value.initialized
                    && widget.controller.videoPlayerController.value.aspectRatio < 1;
